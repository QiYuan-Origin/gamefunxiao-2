...
public class FlashModeListener implements Listener {
    ...
    private void scheduleCrossbowAdvancementCheck(Player player) {
        ...
        org.bukkit.Bukkit.getScheduler().runTask(plugin,
                ...
                () -> plugin.getFlashModeManager().checkFlashCrossbowAdvancement(player));
    ...
    public void onCraftItem(CraftItemEvent event) {
        ...
        if (event.getWhoClicked() instanceof Player player) {
            ...
            scheduleCrossbowAdvancementCheck(player);
    ...
    public void onPlayerQuit(PlayerQuitEvent event) {
        ...
        plugin.getFlashModeManager().cancelDispenserLauncherCharge(event.getPlayer(), false);
        plugin.getFlashModeManager().restoreHappyGhastPassengerFlight(event.getPlayer());
    ...
    public void onPlayerDeath(PlayerDeathEvent event) {
        ...
        plugin.getFlashModeManager().restoreHappyGhastPassengerFlight(event.getEntity());
    ...
    public void onEntityDismount(EntityDismountEvent event) {
        ...
        if (event.getEntity() instanceof Player player) {
            ...
            org.bukkit.Bukkit.getScheduler().runTask(plugin,
                    ...
                    () -> plugin.getFlashModeManager().restoreHappyGhastPassengerFlight(player));
    ...
    public void onPlayerInteract(PlayerInteractEvent event) {
        ...
        boolean endFlashStartupPearl = isEndFlashStartupPhase(player)

                && event.getItem() != null

                && event.getItem().getType() == org.bukkit.Material.ENDER_PEARL;

        if (isFlashPreGameInteractionLocked(player) && !endFlashStartupPearl) {
        ...
        if (endFlashStartupPearl && event.getAction() == org.bukkit.event.block.Action.RIGHT_CLICK_BLOCK) {
        ...
        plugin.getFlashModeManager().ensureFlashBowVirtualArrow(event);
    ...
    public void onPlayerAttemptPickupItem(PlayerAttemptPickupItemEvent event) {
        ...
        plugin.getFlashModeManager().handleFlashCrossbowObtain(event.getPlayer(), event.getItem().getItemStack());

        scheduleCrossbowAdvancementCheck(event.getPlayer());
    ...
    public void onProjectileLaunch(ProjectileLaunchEvent event) {
        ...
        if (event.getEntity().getShooter() instanceof Player player
                ...
                && isFlashPreGameInteractionLocked(player)

                && !(event.getEntity() instanceof EnderPearl && isEndFlashStartupPhase(player))) {
    ...
    public void onEntityTarget(EntityTargetEvent event) {
        ...
        plugin.getFlashModeManager().handleFlashMonsterTarget(event);
    ...
    public void onEntityDamage(EntityDamageEvent event) {
        ...
        plugin.getFlashModeManager().handleFlashGlobalSkeletonTntExplosionDamage(event);

        if (plugin.getFlashModeManager().handleEndDragonRespawnCrystalDamage(event)) {
    ...
    public void onPiglinBarter(PiglinBarterEvent event) {
        ...
        plugin.getFlashModeManager().handleFlashGlobalPiglinBarter(event);
